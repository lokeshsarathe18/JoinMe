...
<body class="w3-light-grey">
				...
				<div class="row">
					<div class="col">
						<div class="info-header mb-5">
							<h1 class="text-primary mt-5 pb-3">Search Tags</h1>
						</div>
					</div>
				</div>
			</div>
	...
	<!--
	<jsp:include page="./frontend/f2/search/main.jsp"></jsp:include>
	<jsp:include page="f2/search/requested.jsp"></jsp:include>
	-->
